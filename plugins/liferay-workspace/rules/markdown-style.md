...
# Markdown Style for the Liferay Workspace Plugin

When creating or editing any Markdown file under the plugin (CLAUDE.md, SKILL.md, rules), follow these conventions.
...
- Use correct casing for brand and product names (Atlassian, Docker, Git, GitHub, Gradle, Jira, Liferay, Playwright, Poshi, REST API, TypeScript).
